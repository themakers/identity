...
const (
	collUser           = "user"
	collAuthentication = "authentication"
)
...
func (b *Backend) session(coll string) (*Collection, func(), error) {
	...
	if b.mgo.sess == nil {
		...
		if b.mgo.testing {
			if err := b.mgo.sess.DB(b.mgo.db).DropDatabase(); err != nil {
				return nil, func() {}, err
			}
		}
	}
...
func (b *Backend) GetAuthentication(id string) (*identity.Authentication, error) {
	panic("implement me")
}

func (b *Backend) CreateAuthentication(id string, objective identity.AuthenticationObjective, userID string) (*identity.Authentication, error) {
	panic("implement me")
}

func (b *Backend) SaveAuthentication(auth *identity.Authentication) error {
	panic("implement me")
}

func (b *Backend) GetUser(id string) (*identity.User, error) {
	panic("implement me")
}

func (b *Backend) CreateUser(user *identity.User) error {
	panic("implement me")
}

func (b *Backend) SaveUser(user *identity.User) error {
	panic("implement me")
}

func (b *Backend) GetUserByIdentity(identityName, identity string) (*identity.User, error) {
	panic("implement me")
}
...
//		return &auth, nil
//	}
//	return &identity.Authentication{ID: SessionToken, RequiredFactorsCount: 1, UserID: "123", FactorsStatus: fs}, nil
//}
//
...
//				"$set": bson.M{
//					"UserID":        uid,
//					"RequiredFactorsCount":  user.AuthFactorsNumber,
//					"FactorsStatus": res,
//				},
//			}, ReturnNew: true,
//		}, &auth); err != nil {
